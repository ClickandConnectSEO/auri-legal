# Discovery calls — script and log

**Goal:** 20 completed calls with owners of small home care agencies.
**Rule:** no code gets written until this file has 20 entries.

---

## Who to call

LinkedIn search: title "Owner" or "Administrator", industry "Individual and Family Services" or "Hospital & Health Care", company size 11-200, keyword "home care".

Also: your own metro. Search "home care agency near me", take the top 30, and call them.
...
Count a call as a **strong yes** only if the owner asks, unprompted, when they are able to have it.

- 8+ strong yes out of 20 → build it.
- Under 8 → the wedge is wrong. Do not build. Reopen niche selection.
